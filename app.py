...
# Memuat model dan vectorizer secara terpisah
model = joblib.load('model_svm_fix.pkl')
vectorizer = joblib.load('tfidf_model_fix.pkl')
...
base_slangwords = {
    ...
    "adaitu":"ada itu", "wajarkrna":"wajar karena", "krna":"karena", "buzzerrp":"buzzer", "aresl":"area",
    "adatxlbh":"adat lebih", "lbh":"lebih", "sedihmelihat":"sedih melihat", "kejahatansetiap":"kejahatan setiap",
    "matakarena": "mata karena","katakatanya":"kata katanya", "bismillahmenurut":"bismillah menurut", "uara":"suara",
    "narasisemoga":"narasi semoga","nyesss":"sakit", "kontenkonten":"konten konten","indonesiasemoga":"indonesia semoga",
    "mantappp":"mantap", "waduhhh":"waduh","kalimantanmemang":"kalimantan memang","sulitapalagi":"sulit apalagi",
    "jawaenakair":"jawa enak air","yaqin":"yakin,","banggasalutterharumerindingkita":"bangga salut terharu merinding kita",
    "alhamdulillahsmg":"alhamdulillah semoga","alhamdulillahsemoga":"alhamdulillah semoga","merindingbetapa":"merinding betapa",
    "airsemua":"air semua","kerennnnnsemoga":"keren semoga","terharuuuuuuuuu":"terharu","terharuu":"terharu","manteppppp":"mantap",
    "pakdhesemoga":"pakdhe semoga","sewotkawatir":"marah khawatir","sewot":"marah","kawatir":"khawatir","embungsmg":"embung semoga",
    "tingal":"tinggal","batmankenapa":"batman kenapa","inisaya":"ini saya","ktahanan":"ketahanan","panganbikin":"pangan bikin",
    "pmerintah":"pemerintah","pindahktp":"pindah ktp","mendoakn":"mendoakan","yahbeda":"yah berbeda", "propinsisemoga":"provinsi semoga",
    "propinsi":"provinsi", "gw":"saya", "aku":"saya", "y":"ya","rcn":"rencana","narasi2":"narasi narasi","bawak":"bawa","p":"bapak","pak":"bapak",
    "hrs":"harus", "alloh":"allah","dn":"dan","dgn":"dengan","alllah":"allah","kerennn":"keren", "smg":"semoga", "bp":"bapak","sdh":"sudah","terwujut":"terwujud",
    "ideide":"ide ide","thn":"tahun","jk":"jika","jln":"jalan","jkw":"jokowi","jama":"zaman","jaman":"zaman","byk":"banyak","kereeen":"keren",
    "klo":"kalau","negatip":"negatif","positip":"positif","dri":"dari","ngak":"tidak","gimna":"gimana","ad":"ada","n":"dan","sll":"selalu","aya":"ada",
    "naon":"apa","orng":"orang","slll":"selalu","brasa":"berasa","sajah":"saja","prof":"profesor","bpk":"bapak","indononesia":"indonesia","ahkir":"akhir",
    "jokowidodosehat":"jokowidodo sehat","sht":"sehat","salud":"salut","dirimu tapi":"diri kamu tapi","dirimu":"diri kamu","jokowiberani":"jokowi berani",
    "iknbaru":"ikn baru","dikalimantansaya":"di kalimantan saya","mangkrakutang":"mangkrak hutang","utang":"hutang","ibukotabaru":"ibu kota baru",
    "kecurangansetiap":"kecurangan setiap","rayapadahal":"raya padahal","dikalbarsedih":"di kalbar sedih","no":"nomor","saudaraa":"saudara",
...
def preprocess_input(text):
    ...
    tokenized = tokenizingText(casefolded)
    stemmed = stemmingText(tokenized)
    slang_fixed = fix_slangwords(toSentence(stemmed), all_slangwords)  # Memasukkan all_slangwords
    # Pastikan outputnya bentuk kalimat string
    final_text = toSentence(slang_fixed.split())
    return final_text
...
def analyze_sentiment():
    ...
    try:
        ...
        return jsonify({"error": f"Preprocessing/vectorizing error: {str(e)}"}), 500

    # Predict sentiment
    try:
        sentiment = model.predict(input_vector)
        sentiment_text = "Positive" if sentiment[0] == 1 else "Negative"
