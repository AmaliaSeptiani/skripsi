...
# Fungsi Preprocessing (satu kalimat)
# Fungsi Preprocessing (satu kalimat)
...
def prediksi_sentimen(kalimat):
    ...
    return "Positif" if prediksi == 1 else "Negatif"

# Input dari user
kalimat = input("Masukkan kalimat untuk analisis sentimen: ")
label = prediksi_sentimen(kalimat)
